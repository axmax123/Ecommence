...
namespace Ecoommence.EntityData.Extentions
{
    public static class ModelBuilderExtensions 
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
            //Appconfig Data Seeding
            ...
            // ProductXCategory Data
            modelBuilder.Entity<ProductXCategory>().HasData
                (
                new ProductXCategory() { CategoryId = 1, ProductId = 1}
                );
        }
    }
}
